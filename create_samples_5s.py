...
FILE_LIST = './data/selected_files/sample_files_tbp04.txt'
OUT_DIR = './data/5s/wav_sample/Batch_TBP_04'

TEMP_FILENAME = 'tempfile.wav'

SAMPLE_DURATION = 5  # seconds
# take up to 12 samples from each track
# SAMPLES_START_AT = [30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330, 360]
# take up to 8 samples from each track
SAMPLES_START_AT = [30, 60, 90, 120, 150, 180, 210, 240]
SAMPLE_RATE = 44100
